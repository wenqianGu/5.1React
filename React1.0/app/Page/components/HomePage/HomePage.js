        ...
        <div className="card-top">
            ...
            <div className="personal__info">
                ...
                <div className="personal__info__contacts">
                    <img className="personal__info__contacts__icon" src="../../../../assets/img/facebook-brands.svg"
                         alt=""/>
                    <img className="personal__info__contacts__icon"
                         src="../../../../assets/img/square-instagram-brands.svg"
                         alt=""/>
                    <img className="personal__info__contacts__icon" src="../../../../assets/img/twitter-brands.svg"
                         alt=""/>
                </div>
            </div>
        </div>
        <div className="card_bottom">
            <div className="card_bottom_AboutMe">
                <div className="card_bottom_AboutMe_title">
                    <span>About</span>
                    <span className="card_bottom_AboutMe_Me">Me</span>
                </div>
